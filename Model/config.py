...
class Config:
    ...
    # Ajustar según VRAM: 6GB -> 1, 12GB -> 4, 24GB+ -> 8
    GROUP_SIZE = int(os.getenv("GROUP_SIZE", 1)) 
    # Canales de proyección de acción (128 para GPUs pequeñas, 1440 para GPUs grandes)
    ...
    def print_config(cls):
        print("--- CONFIGURACIÓN ACTUAL DE AUTOFSD ---")
