...
def main():
    ...
    print(f"Cargando dataset para: {Config.TARGET_COUNTRY}...")
    dataset = load_spain_subset()
    if dataset is None or len(dataset) == 0:
        print(f"Error: No se pudo cargar el dataset real para {Config.TARGET_COUNTRY}. Verifica los archivos descargados.")
        return
