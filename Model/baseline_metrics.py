...
def main():
    ...
    # Add batch dimension
    visual_tiles = visual_tiles.unsqueeze(0).to(device)
    egomotion_history = egomotion_history.unsqueeze(0).to(device)
    visual_history = visual_history.unsqueeze(0).to(device)
